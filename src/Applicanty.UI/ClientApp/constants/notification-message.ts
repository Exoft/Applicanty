export class NotificationMassage {
    ...
    static VACANCYCHANGESTATUSSUCCES: string = 'Vacancy status changed successfully';
    static VACANCIESCHANGESTATUSSUCCES: string = 'Vacancies status changed successfully';
    static VACANCYCHANGESTATUSERROR: string = 'Error occurred during status change';
