...
export class VacanciesDataService {
    ...
    public getVacancies(statusType: number, gridRequest: GridRequest): Observable<any> {
        ...
        return this.http.post(`${environment.apiRootUrl}vacancy/getAll`,
            gridRequest, { headers: this.authService.getAuthenticationHeader(), params: params });
    }
    ...
    public changeVacanciesStatus(ids: number[], status: any): Observable<any> {
        ...
        return this.http.post(`${environment.apiRootUrl}vacancy/changeStatus`,
            ids, { headers: this.authService.getAuthenticationHeader(), params: params });
    }
    ...
    public getVacancyStagesCount(id: number): Observable<any> {
        ...
        return this.http.get(`${environment.apiRootUrl}vacancy/countVacancyStageCandidates`,
    ...
    public getCandidateByVacancy(vacancyId: string): Observable<any> {
        ...
        return this.http.get(`${environment.apiRootUrl}candidate/getByVacancy`,
            { headers: this.authService.getAuthenticationHeader(), params: params });
    }
    ...
    public getCandidateByTechnologyAndExperience(experience: number, technologyIds: number[]): Observable<any> {
        ...
        return this.http.post(`${environment.apiRootUrl}candidate/getByTechnologyAndExperience`,
            technologyIds, { headers: this.authService.getAuthenticationHeader(), params: params });
    }

    public attachVacancyToCandidateStage(request: any): Observable<any> {
        return this.http.post(`${environment.apiRootUrl}vacancy/attachCandidate`, request,
